  ...
  return (
    <div>
      <div className="w-full flex mt-8 justify-center items-center">
        <div className="md:w-[50%] md:flex md:gap-[5rem] md:items-center md:justify-center font-semibold justify-center">
          <div
            className={
              router.asPath === "/"
          ...
          <div
            className={
              router.asPath === "/giftPage" || router.asPath === "/checkout/id"
                ? "text-[#7F9B2D] ease-in-out duration-500 cursor-pointer text-[18px]"
                : "hover:text-[#7F9B2D] ease-in-out duration-500 cursor-pointer text-[18px]"
            }
            onClick={() => {
